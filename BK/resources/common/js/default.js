var IEVersionCheck = function(){
    ...
    $(function(){
        ...
        */
        ...
        $('body div#subWrap li.1Depth > a').on('click', function(e) {
            var listDepth2 = $(this).parent().find('li.2Depth');
            var listDepth3 = listDepth2.eq(0).find('li.3Depth');
            if ( listDepth3.length > 0 ) {
                e.stopPropagation();
        ...
        $('body div#wrap li.2Depth > a').on('click', function(e) {
            ...
            if ( listDepth3.length > 0 ) {
                ...
                if (listDepth4.length > 0) {
                    listDepth4.eq(0).find('span').eq(0).click();
                } else {
                    listDepth3.eq(0).find('span').eq(0).click();
                }
        ...
        $('body div#subWrap li.2Depth > a').on('click', function(e) {
            var listDepth3 = $(this).parent().find('li.3Depth');
