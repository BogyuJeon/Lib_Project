		...
		<body>
			...
			$(function() {
					...
					<tbody>
						<tr class="first">
							...
							<td class="joinImg3 td5">
								<span class=""><img src="/common/img/mem_prcs03_on.png" alt=""></span><br>
				...
				<div class="join-wrap" style="padding: 0">
					...
					<form id="loginForm" action="/busanlibrary/intro/login/index.do" method="post">
					...
					<form id="memberJoinForm" action="edit.do" method="post">
						<input id="newMemberId" name="member_id" type="hidden" value="">
						<input id="editMode" name="editMode" type="hidden" value="ADD">
						<input id="user_position" name="user_position" type="hidden" value="">
						<input id="agree_codes" name="agree_codes" type="hidden" value="1,1,1,2,on">
						<input id="certType" name="certType" type="hidden" value="">
						<input id="before_url" name="before_url" type="hidden" value="">
						<input id="menu_idx" name="menu_idx" type="hidden" value="57">
						<input id="langMode" name="langMode" type="hidden" value="kor">
						<div style="display:none;">
						* 보호자(법정대리인) 본인인증 버튼입니다. 보호자 인증 후 만 14세 미만 본인인증 선택화면이 나타납니다.
						</div>
						<div class="identi_select" style="display:none;">
							<p class="identy_a">
								<a href="/auth/Privacy" title="새창열림" class="certtype" id="parentSms">
									<img src="/common/img/identy1.png" alt="">
									<span>휴대폰 본인인증</span>
								</a>
							</p>
							<p class="identy_b">
								<a href="/auth/Privacy" title="새창열림" class="certtype" id="parentGpin">
									<img src="/common/img/identy2.png" alt="">
									<span>I-PIN(아이핀)인증</span>
								</a>
							</p>
						</div>
						<table style="margin-bottom:50px; display:none;">
							<tbody>
								<tr class="first">
									<td style="font-weight: bold; background: #f8f8f8" class="first td1">
										보호자(법정대리인) 본인인증
									</td>
									<td id="parentCert" class="last td2">
										* 본인인증방법을 선택해 주세요.
									</td>
								</tr>
								<tr>
									...
									<td id="parentName" class="last td2">
						...
						* 실제 가입하려는 만 14세 미만 아동의 명의로 된 휴대폰 또는 아이핀으로 인증하시기 바랍니다.
							...
							<p class="identy_a">
								<a href="/auth/Privacy" title="새창열림" class="certtype" id="certSms">
									<img src="/common/img/identy1.png" alt="">
									<span>휴대폰 본인인증</span>
								</a>
							</p>
							<p class="identy_b">
								<a href="/auth/Privacy" title="새창열림" class="certtype" id="certGpin">
									<img src="/common/img/identy2.png" alt="">
									<span> I-PIN(아이핀)인증</span>
								</a>
							</p>
